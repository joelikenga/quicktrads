...
export const Hero1 = () => {
  ...
  return (
    <div className="w-full lg:px-10 mt-20 lg:mt-[152px] my-8">
      {loading ? (
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between md:h-[440px] px-6 md:px-10 lg:px-20 mx-auto w-full max-w-7xl bg-gray-300" />
      ) : data ? (
        <div
        ...
        <div className="flex text-[50px] items-center  font-medium justify-center md:h-[440px] px-6 md:px-10 lg:px-20 mx-auto w-full max-w-7xl bg-gray-300">
          No Content
        </div>
      )}
    </div>
