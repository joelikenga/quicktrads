...
const OrderInfoSkeleton = () => (
  <div className="grid grid-cols-2 md:grid-cols-5 p-6 w-full max-w-[940px] border rounded-lg mt-8 animate-pulse gap-4">
    <div className="flex gap-8 items-center col-span-1 py-2 md:py-0">
    ...
    <div className="flex gap-8 items-center col-span-1 md:border-x-2 px-2 md:px-6 py-2 md:py-0">
      <div className="flex flex-col gap-2">
    ...
    <div className="flex gap-8 items-center col-span-1 px-2 md:px-6 py-2 md:py-0">
      <div className="flex flex-col gap-2">
    ...
    <div className="hidden md:flex gap-8 items-center col-span-1 px-6">
      <div className="flex flex-col gap-2">
        <div className="h-4 w-16 bg-gray-200 rounded"></div>
        <div className="h-4 w-24 bg-gray-200 rounded"></div>
      </div>
...
const OrderItemsSkeleton = () => (
  <div className="overflow-x-auto max-w-[651px] w-full">
    <table className="w-full divide-y divide-stroke_weak">
      <thead className="text-start bg-background border-y">
        <tr>
          {["Product details", "Size", "Quantity", "Price"].map((header) => (
            <th key={header} className="px-4 py-3 text-start font-normal text-sm h-10">
              {header}
            </th>
          ))}
        </tr>
        ...
        {[...Array(3)].map((_, i) => (
          <tr key={i} className="border-b">
            <td className="pl-4 py-4">
              <div className="flex gap-6 items-start w-full md:w-[360px]">
                <div className="w-[70px] h-[85px] bg-gray-200 rounded"></div>
                <div className="h-4 w-full md:w-32 bg-gray-200 rounded"></div>
              </div>
            </td>
...
const TrackOrdersSkeleton = () => (
  <div className="w-full max-w-[829px] flex flex-col gap-12 py-6 border-t animate-pulse">
    <div className="overflow-x-auto">
      <div className="w-full min-w-[600px] grid grid-cols-5 gap-4">
        <div className="col-span-1 flex gap-4 pr-6">
        ...
        <div className="col-span-2 flex flex-col gap-2 px-6 border-x-2">
          <div className="h-4 w-28 bg-gray-200 rounded"></div>
          <div className="h-4 w-32 bg-gray-200 rounded"></div>
          <div className="h-4 w-48 bg-gray-200 rounded"></div>
        </div>

        <div className="col-span-2 flex flex-col gap-2 pl-4">
          <div className="h-4 w-28 bg-gray-200 rounded"></div>
    ...
    <div className="overflow-x-auto">
      <div className="w-fit flex gap-16 min-w-[400px]">
        {[...Array(3)].map((_, i) => (
    ...
    <div className="md:ml-[280px] mt-[150px]">
      ...
      <div className="flex justify-between gap-2 items-center font-normal text-nowrap w-full">
        <div
          ...
          className="text-text_strong text-base md:text-[22px] flex items-center gap-2 cursor-pointer"
        >
          {arrowleft()}
          <>Order details</>
        </div>
      ...
      <div className="px-0 md:px-7 flex flex-col gap-12">
        {loading ? (
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 p-6 w-full max-w-[940px] border rounded-lg mt-8 gap-4">
            <div className="flex gap-8 items-center col-span-1 py-2 md:py-0">
              <i>{orderSmallIcon()}</i>
            ...
            <div className="flex gap-8 items-center col-span-1 px-2 md:px-6 py-2 md:py-0">
              <div className="flex-col items-center justify-center">
                <p className="text-text_weak text-nowrap">Payment method</p>
                <p className="text-text_strong">
