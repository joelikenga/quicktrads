...
export const Items = () => {
    return(
        <div className="grid grid-cols-3 flex-row flex-wrap gap-6 w-full justify-between">
          {content.map((item, index) => {
            return (
              <div
                key={index}
                className="col-span-1 flex flex-col items-center gap-4 h-ful w-full  max-w-[400px]  h-fit pb-[22px]"
              >
