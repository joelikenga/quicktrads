                    ...
                    <div className="mt-[120px] ml-[160px]">
                        ...
                        <div className="flex border border-stroke_weak py-[16px] px-[48px] w-[937px] rounded-lg  gap-4">
                            ...
                            <section className="flex items-center gap-4">
                                ...
                                <div className="w-[134px] h-[85px] text-center">
                                    <p className="text-[14px] leading-[22px] text-text_weak">Total sales</p>
                                ...
                                <div className="w-[134px] h-[85px] text-center">
                                    <p className="text-[14px] leading-[22px] text-text_weak">Total order</p>
                                    <p className={`${lora.className} text-[22px] leading-[28px] font-[400] py-2`}>$0.0</p>
                                    <p className="text-[14px] leading-[22px] text-text_weak">0.0</p>
                                </div>
                                ...
                                <div className="w-[134px] h-[85px] text-center">
                                    <p className="text-[14px] leading-[22px] text-text_weak">Average order</p>
                                    <p className={`${lora.className} text-[22px] leading-[28px] font-[400] py-2`}>$0.0</p>
                                    <p className="text-[14px] leading-[22px] text-text_weak">0.0</p>
                                </div>
                        ...
                        <div className="flex justify-center h-[455px] items-center">
                            <div className=" flex flex-col w-[400px] h-[80px]">
                                ...
                                <h3 className="pb-4 py-[16px] text-[18px] leading-[28px] text-center font-[500]">There are currently no sales!</h3>
                                <p className="text-[14px] leading-[22px] text-text_weak w-[266px] mx-auto text-center">It looks like there are currently no sales available at the moment</p>
                            </div>
                        </div>
                    </div>
                </div>
