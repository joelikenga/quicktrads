...
import { getOrders } from "@/utils/api/admin/products";
          ...
          <div className=" w-full flex justify-center items-center mt-12">
            <div className="w-full max-w-[400px] flex flex-col gap-8 items-center">
              ...
              <div className="flex flex-col gap-4 font-normal text-center ">
                ...
                <p className="text-text_weak text-base max-w-[350px]">{`It looks like there are currently no orders available at the moment`}</p>
              </div>
              <button className="bg-text_strong text-background font-medium text-base h-12 w-fit px-6 flex rounded-full items-center justify-center">
                Add inventory
              </button>
            </div>
          </div>
                          ...
                          <div className=" w-full flex justify-center items-center my-12">
                            <div className="w-full max-w-[400px] flex flex-col gap-4 items-center">
                              ...
                              <div className="flex flex-col gap-2 font-normal text-center ">
                                <p className="text-text_strong text-[22px] ">{`No matching order !`}</p>
                                <p className="text-text_weak text-base max-w-[350px]">{`It looks like there are currently no orders  matching`}</p>
                                <p className="text-text_weak text-base max-w-[350px]">{`" ${search} "`}</p>
                              </div>
                            </div>
                          </div>
                        </div>{" "}
