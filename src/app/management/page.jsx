                ...
                <div>
                    ...
                    <div className="h-full flex justify-center items-center w-[70svw]">
                        <div className='flex flex-col w-full justify-center items-center'>
                            ...
                            <p className='text-text_weak text-sm pb-4'>It looks like there are currently no products available at the moment</p>
                            <Link href={``} clasName='bg-text_strong text-backgrond py-2 px-6'>Add product</Link>
                        </div>
                    </div>
                </div>
            </div>
